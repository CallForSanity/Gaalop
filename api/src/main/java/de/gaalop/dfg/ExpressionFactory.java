...
public final class ExpressionFactory {
    ...
    /**
     * This class is the base class for creators of binary operations. This class uses
     * the template method/factory method pattern to decide which operation should be
     * created.
     *
     ...
     *
     * @param operands The operands for the sum. A deep copy of each expression will be created. At least two operands are required.
     ...
     *
     * @param operands The operands for the subtraction. A deep copy of each expression will be created. At least two operands are required.
     ...
     *
     * @param factors The factors of the product. At least two have to be present. A deep copy of each operand is created.
    ...
    /**
     * Constructs an expression that represents the outer product of all given factors in the order
     * they are given.
     *
