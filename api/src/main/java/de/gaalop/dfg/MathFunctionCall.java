...
public final class MathFunctionCall extends UnaryOperation {
     ...
     *
     * @return The string "<code>function(operand)</code>" where function and operand are both converted to
     ...
     *
     * Math function calls are equal if and only if they have the same class, their operands are equal and the
     * function type is equal.
     *
