...
public class CppVisitor extends DefaultCodeGeneratorVisitor {
    ...
    public void visit(StoreResultNode node) {
        assigned.add(node.getValue().getName()); // eval GPC: In GPC this may be required: assigned.add(node.getValue().getName() + suffix);
        node.getSuccessor().accept(this);
    }
    ...
    public void visit(EndNode node) {
        ...
        // TODO eval GPC: In GPC this is not possible to declare libraries in embedding function
