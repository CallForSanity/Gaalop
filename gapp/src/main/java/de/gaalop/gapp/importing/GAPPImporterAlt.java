 ...
 */
public class GAPPImporterAlt extends EmptyControlFlowVisitor implements ExpressionVisitor {
     ...
     */
    public GAPPImporterAlt(UseAlgebra usedAlgebra) {
    ...
    private void createCommandSeriesDotProd(GAPPMultivector destMv, Selector destSel, GAPPMultivector src1, GAPPMultivector src2, Selectorset sel1, Selectorset sel2) {
        ...
        vectors.add(v1);
        vectors.add(v2);
        curGAPP.addInstruction(new GAPPDotVectors(destMv, destSel, vectors));
    }
    ...
    public void visit(MathFunctionCall node) {
        ...
        System.err.println("Warning: MathFunctionCall ("+node.getFunction().toString()+") is only implemented for scalars!");
    }
