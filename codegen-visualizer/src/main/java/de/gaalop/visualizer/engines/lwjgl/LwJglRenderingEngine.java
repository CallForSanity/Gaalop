...
// Camera information
Vec3f camPos = new Vec3f(0.0f, 2.0f, -10.0f);       // camera position
Vec3f camDir = new Vec3f(0.0f, 0.0f, 1.0f);         // camera lookat (always Z)
Vec3f camUp = new Vec3f(0.0f, 1.0f, 0.0f);          // camera up direction (always Y)
float camAngleX=0.0f, camAngleY=0.0f;   // camera angles
// Light information
Vec3f lightPos= new Vec3f(10.0f, 30.0f, -10.0f);
// Mouse information
