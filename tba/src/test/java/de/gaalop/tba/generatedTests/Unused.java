...
public class Unused implements GAProgram {
	...
	public void calculate() {
		...
		Din$6 = rotor$6; // e1^e2;
		Din$7 = rotor$7; // e1^e3;
		Din$8 = (((translator$8 * rotor$0) + (-((translator$11 * rotor$6)))) + (-((translator$13 * rotor$7)))); // e1^einf;
		Din$10 = rotor$10; // e2^e3;
		Din$11 = (((translator$8 * rotor$6) + (translator$11 * rotor$0)) + (-((translator$13 * rotor$10)))); // e2^einf;
		Din$13 = (((translator$8 * rotor$7) + (translator$11 * rotor$10)) + (translator$13 * rotor$0)); // e3^einf;
		Din$26 = (((translator$8 * rotor$10) + (-((translator$11 * rotor$7)))) + (translator$13 * rotor$6)); // e1^e2^e3^einf;
	}
