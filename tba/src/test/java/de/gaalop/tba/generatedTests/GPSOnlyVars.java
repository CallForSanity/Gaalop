...
public class GPSOnlyVars implements GAProgram {
	...
	public void calculate() {
		...
		z11$0 = ((float) Math.sqrt((-2.0f * ((((((rc1N$1 * sat1x$0) + (rc1N$2 * sat1y$0)) + (rc1N$3 * sat1z$0)) + (-rc1N$4)) + (-((rc1N$5 * sat1$4))))))) - d1$0); // 1.0;
		z12$0 = ((float) Math.sqrt((-2.0f * ((((((rc2N$1 * sat1x$0) + (rc2N$2 * sat1y$0)) + (rc2N$3 * sat1z$0)) + (-rc2N$4)) + (-((rc2N$5 * sat1$4))))))) - d1$0); // 1.0;
		z21$0 = ((float) Math.sqrt((-2.0f * ((((((rc1N$1 * sat2x$0) + (rc1N$2 * sat2y$0)) + (rc1N$3 * sat2z$0)) + (-rc1N$4)) + (-((rc1N$5 * sat2$4))))))) - d2$0); // 1.0;
		z22$0 = ((float) Math.sqrt((-2.0f * ((((((rc2N$1 * sat2x$0) + (rc2N$2 * sat2y$0)) + (rc2N$3 * sat2z$0)) + (-rc2N$4)) + (-((rc2N$5 * sat2$4))))))) - d2$0); // 1.0;
		z31$0 = ((float) Math.sqrt((-2.0f * ((((((rc1N$1 * sat3x$0) + (rc1N$2 * sat3y$0)) + (rc1N$3 * sat3z$0)) + (-rc1N$4)) + (-((rc1N$5 * sat3$4))))))) - d3$0); // 1.0;
		z32$0 = ((float) Math.sqrt((-2.0f * ((((((rc2N$1 * sat3x$0) + (rc2N$2 * sat3y$0)) + (rc2N$3 * sat3z$0)) + (-rc2N$4)) + (-((rc2N$5 * sat3$4))))))) - d3$0); // 1.0;
	}
