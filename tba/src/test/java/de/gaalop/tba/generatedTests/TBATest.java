...
assertEquals(12, outputs.size());
  ...
  public void testLinePointDistance0() {
    ...
    assertTrue(inst.setValue("p1$x$0",3.0f));
    assertTrue(inst.setValue("p1$y$0",4.0f));
    assertTrue(inst.setValue("p1$z$0",5.0f));
    assertTrue(inst.setValue("p2$x$0",7.0f));
    assertTrue(inst.setValue("p2$y$0",8.0f));
    assertTrue(inst.setValue("p2$z$0",10.0f));
    assertTrue(inst.setValue("pTst$x$0",3.0f));
    assertTrue(inst.setValue("pTst$y$0",8.0f));
    assertTrue(inst.setValue("pTst$z$0",10.0f));
    inst.calculate();
    // collect outputs
    HashMap<String,Float> outputs = inst.getValues();
    // check outputs
