...
public class LinePointDistance implements GAProgram {
	// input variables
	private float p1$x$0;
	private float p2$z$0;
	private float p1$z$0;
	private float p1$y$0;
	private float pTst$x$0;
	private float pTst$z$0;
	private float pTst$y$0;
	private float p2$y$0;
	private float p2$x$0;
	...
	public boolean setValue(String varName, float value) {
		if (varName.equals("p1$x$0")) { p1$x$0 = value; return true; }
		if (varName.equals("p2$z$0")) { p2$z$0 = value; return true; }
		if (varName.equals("p1$z$0")) { p1$z$0 = value; return true; }
		if (varName.equals("p1$y$0")) { p1$y$0 = value; return true; }
		if (varName.equals("pTst$x$0")) { pTst$x$0 = value; return true; }
		if (varName.equals("pTst$z$0")) { pTst$z$0 = value; return true; }
		if (varName.equals("pTst$y$0")) { pTst$y$0 = value; return true; }
		if (varName.equals("p2$y$0")) { p2$y$0 = value; return true; }
		if (varName.equals("p2$x$0")) { p2$x$0 = value; return true; }
		return false;
	}
	...
	public void calculate() {
		...
		L$6 = (v1$3 + (-v2$3)); // e1^e2;
		L$7 = (-((v1$2 + (-v2$2)))); // e1^e3;
		L$8 = (-(((v1$2 * v2$3) + (-((v1$3 * v2$2)))))); // e1^einf;
		L$10 = (v1$1 + (-v2$1)); // e2^e3;
		L$11 = ((v1$1 * v2$3) + (-((v1$3 * v2$1)))); // e2^einf;
		L$13 = (-(((v1$1 * v2$2) + (-((v1$2 * v2$1)))))); // e3^einf;
		...
		V$1 = ((((((((((((R$0 * vTst$1) + (R$6 * vTst$2)) + (R$7 * vTst$3)) + (-R$8))) * R$0) + (-(((((((R$0 * vTst$2) + (-((R$6 * vTst$1)))) + (R$10 * vTst$3)) + (-R$11))) * (-R$6))))) + (-(((((((R$0 * vTst$3) + (-((R$7 * vTst$1)))) + (-((R$10 * vTst$2)))) + (-R$13))) * (-R$7))))) + (R$0 * (-R$8))) + (-((((((R$6 * vTst$3) + (-((R$7 * vTst$2)))) + (R$10 * vTst$1))) * (-R$10))))) + (R$6 * (-R$11))) + (R$7 * (-R$13))); // e1;
		V$2 = ((((((((((((R$0 * vTst$1) + (R$6 * vTst$2)) + (R$7 * vTst$3)) + (-R$8))) * (-R$6)) + ((((((R$0 * vTst$2) + (-((R$6 * vTst$1)))) + (R$10 * vTst$3)) + (-R$11))) * R$0)) + (-(((((((R$0 * vTst$3) + (-((R$7 * vTst$1)))) + (-((R$10 * vTst$2)))) + (-R$13))) * (-R$10))))) + (R$0 * (-R$11))) + (((((R$6 * vTst$3) + (-((R$7 * vTst$2)))) + (R$10 * vTst$1))) * (-R$7))) + (-((R$6 * (-R$8))))) + (R$10 * (-R$13))); // e2;
		V$3 = ((((((((((((R$0 * vTst$1) + (R$6 * vTst$2)) + (R$7 * vTst$3)) + (-R$8))) * (-R$7)) + ((((((R$0 * vTst$2) + (-((R$6 * vTst$1)))) + (R$10 * vTst$3)) + (-R$11))) * (-R$10))) + ((((((R$0 * vTst$3) + (-((R$7 * vTst$1)))) + (-((R$10 * vTst$2)))) + (-R$13))) * R$0)) + (R$0 * (-R$13))) + (-((((((R$6 * vTst$3) + (-((R$7 * vTst$2)))) + (R$10 * vTst$1))) * (-R$6))))) + (-((R$7 * (-R$8))))) + (-((R$10 * (-R$11))))); // e3;
		V$5 = ((((R$0 * R$0) + (-((R$6 * (-R$6))))) + (-((R$7 * (-R$7))))) + (-((R$10 * (-R$10))))); // e0;
		P$1 = (-(((((((v1$2 * v2$3) + (-((v1$3 * v2$2))))) * V$5) + (-((((v1$2 + (-v2$2))) * V$3)))) + (((v1$3 + (-v2$3))) * V$2)))); // e1;
		P$2 = ((((((v1$1 * v2$3) + (-((v1$3 * v2$1))))) * V$5) + (-((((v1$1 + (-v2$1))) * V$3)))) + (((v1$3 + (-v2$3))) * V$1)); // e2;
		P$3 = (-(((((((v1$1 * v2$2) + (-((v1$2 * v2$1))))) * V$5) + (-((((v1$1 + (-v2$1))) * V$2)))) + (((v1$2 + (-v2$2))) * V$1)))); // e3;
		P$4 = (-(((((((v1$1 * v2$2) + (-((v1$2 * v2$1))))) * V$3) + (-(((((v1$1 * v2$3) + (-((v1$3 * v2$1))))) * V$2)))) + ((((v1$2 * v2$3) + (-((v1$3 * v2$2))))) * V$1)))); // einf;
		...
		abstand$0 = (float) Math.sqrt((float) Math.abs(((((((Pa$1 * vTst$1) + (Pa$2 * vTst$2)) + (Pa$3 * vTst$3)) + (-Pa$4))) * (((((Pa$1 * vTst$1) + (Pa$2 * vTst$2)) + (Pa$3 * vTst$3)) + (-Pa$4)))))); // 1.0;
		nor$1 = Pa$1; // e1;
		nor$2 = Pa$2; // e2;
		nor$3 = Pa$3; // e3;
	...
	private float Pa$4;
	private float Pa$3;
	private float vTst$3;
	private float L$8;
	private float vTst$2;
	private float vTst$1;
	private float R$0;
	private float La$13;
