...
public class CircleOneVar implements GAProgram {
	...
	public void calculate() {
		v1$1 = x1$0; // e1;
		p1$1 = v1$1; // e1;
		p1$4 = (((v1$1 / 2.0f) * v1$1) + 2.0f); // einf;
		c$7 = (((90.0f + (-((p1$4 * 9.0f)))) + 182.0f) + (((p1$4 + -45.0f)) * 4.0f)); // e1^e3;
		c$10 = (-(((((p1$1 * 45.0f) + (-((p1$4 * 3.0f)))) + (-((((p1$1 + -3.0f)) * 26.0f)))) + (((p1$4 + -45.0f)) * 6.0f)))); // e2^e3;
		c$13 = (-(((((((p1$1 * 9.0f) + -6.0f)) * 26.0f) + (-(((((p1$1 * 45.0f) + (-((p1$4 * 3.0f))))) * 4.0f)))) + (((90.0f + (-((p1$4 * 9.0f))))) * 6.0f)))); // e3^einf;
		c$14 = ((((p1$1 * 9.0f) + -6.0f) + (-((((p1$1 + -3.0f)) * 4.0f)))) + -42.0f); // e3^e0;
