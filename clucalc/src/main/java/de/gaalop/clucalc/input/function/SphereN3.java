...
/**
 * This class implements the SphereN3 function as defined in the CluCalc documentation.
 */
public class SphereN3 implements Function {
  ...
  private Expression createSphere(AlgebraMode mode, Expression center, Expression radius) {
    return subtract(center, product(HALF.copy(), square(radius), mode.getConstant("einf")));
  }
}
