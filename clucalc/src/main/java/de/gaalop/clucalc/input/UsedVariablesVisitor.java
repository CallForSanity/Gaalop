...
/**
 * Keeps track of variables that are actually in use. This can be used to detect unused variables in
 * order to remove them from the graph. Used variables can be queried by {@link #getVariables()}.
 */
