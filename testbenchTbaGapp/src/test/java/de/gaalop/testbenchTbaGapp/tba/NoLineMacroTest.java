 ...
 * @author csteinmetz15
 */
public class NoLineMacroTest implements TBATestCase {

    public NoLineMacroTest() {
    }
    ...
    public void testOutputs(HashMap<Variable, Double> outputs) {
        ...
        assertEquals(5,outputs.get(new MultivectorComponent("d", 0)),0.01);
        assertEquals(10,outputs.get(new MultivectorComponent("f", 0)),0.01);
