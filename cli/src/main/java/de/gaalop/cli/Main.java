...
public class Main {
  ...
  @Option(name = "--gpc", required = false, usage = "Required to use gpc.")
  ...
  @Option(name = "--outputFile", aliases = { "--of" },required = false, usage = "Sets the output file.")
  ...
  @Option(name = "--pragmas", required = false, usage = "Whether or not to write line pragmas for compile errors.")
  private boolean writeLinePragmas = false;

  @Option(name = "--double", required = false, usage = "Whether or not to use double precision foating point format.")
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
       ...
       if (main.cli)
        ...
        de.gaalop.gpc.Main.inputFilePath = main.inputFile;
        de.gaalop.gpc.Main.outputFilePath = main.outputFile;
        de.gaalop.gpc.Main.externalOptimizerPath = main.maximaPath;
        de.gaalop.gpc.Main.codeParserPlugin = main.codeParserPlugin;
        de.gaalop.gpc.Main.codeGeneratorPlugin = main.codeGeneratorPlugin;
        de.gaalop.gpc.Main.optimizationStrategyPlugin = main.optimizationPlugin;
        de.gaalop.gpc.Main.globalSettingsStrategyPlugin = main.globalSettingsPlugin;
        de.gaalop.gpc.Main.algebraStrategyPlugin = main.algebraPlugin;
        de.gaalop.gpc.Main.visualizerStrategyPlugin = main.visualCodeInserterPlugin;
        de.gaalop.gpc.Main.writeLinePragmas = main.writeLinePragmas;
        de.gaalop.gpc.Main.useDoubles = main.useDoubles;
        de.gaalop.gpc.Main.algebraName = main.algebraName;    
        de.gaalop.gpc.Main.algebraBaseDirectory = main.algebraBaseDirectory;
    

        de.gaalop.gpc.Main.runGPC();
       }
