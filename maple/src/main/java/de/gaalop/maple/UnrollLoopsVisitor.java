...
/**
 * This visitor traverses the {@link ControlFlowGraph} and tries to unroll loops where applicable. Therefore, loops have
 * to be analyzed or marked in the input file in order to get the number of iterations. According to this number, the
 * loop body is copied multiple times. Nested loops are unrolled too, iff the number of iterations in this loop and
 * parent loops is greater than 0.
 * 
